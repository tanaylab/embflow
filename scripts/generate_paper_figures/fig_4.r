...
mesoderm_mc_graphs = function() {
  ...
  diag(confu) = 0
  colnames(confu)[1] = "-1"
  fig_dir = "figs/paper_figs/fig4/nascent_mesoderm"
  if(!dir.exists(fig_dir)) {
    dir.create(fig_dir)
  }
  fig_dir = "figs/paper_figs/fig4/nascent_mesoderm/mc_graphs"
  if(!dir.exists(fig_dir)) {
    dir.create(fig_dir)
  }
  ...
  genes = c("Etv2","Tal1","Kdr","Six2","Lhx1","Myl7","Hand2","Eomes","T","Sp5","Twist1","Snai1","Epcam","Fn1",
            "Hand1","Msx1","Msx2","Foxc1","Foxc2","Lefty2","Zic3","Foxa2","Gsc","Runx1","Smarcd3","Smad1","Fgf10","Tbx3","Gata4","Gata6","Mesp1","Mesp2",
            "Prdm6","Igf2","Lmo1","Zfpm1","Mixl1","Pdgfra","Frzb","Dll3","Cyp26a1","Crabp1","Sfrp1")
...
epiblast_mc_graphs = function() {
  ...
  genes = c("Apln","Ccnd2;CYL2","Dppa4","Dnmt3l","Fgf4","Dnmt3a","Dnmt3b","Fgf5","Fgf15","Tdgf1","Pmepa1","Skil","Foxd3","Smad7","Dusp6","Sgk1","Nodal","Myc","Irf1","Id1",
            "Foxb1","Fst","Irx3","Irx5","Sox9","Crabp2","Id2","Rgma","Sp8","Gbx2","Sox1","Sall3","Zic3",
            "Eomes","Axin2","Fgf8","Pou3f1","Utf1","T","Sp5","Six3","Mixl1","Gsc","Foxa2","Otx2","Hes1")
  
  incl_colors = c("#635547","#DABE99","#9e6762","#65A83E","#647a4f","#354E23")
  
  for(gene in genes) {
    plot_time_gene_mc_flow(confu = confu,mc = mc,mc_t = mc_t,gene = gene,incl_colors = incl_colors,fig_dir = "figs/paper_figs/fig4/epiblast_dynamics/mc_graphs",max_t = 13,fig_pref = "epiblast",plot_pdf = T)
  }
